...
/**
 * This is the model class for table "hasilrepair".
 *
 * The followings are the available columns in table 'hasilrepair':
 * @property integer $id
 ...
 */
class Hasilrepair extends CActiveRecord
{
	/**
	 ...
	 * @return Hasilrepair the static model class
	 */
