 ...
 *
 * The followings are the available columns in table 'produksi':
 * @property integer $id
...
class Produksi extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_material, progres, keterangan, tgl_create', 'required'),
			array('id_material, progres', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_material, progres, keterangan, tgl_create', 'safe', 'on'=>'search'),
		);
	}
