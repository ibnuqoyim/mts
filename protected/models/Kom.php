...
/**
 * This is the model class for table "kom".
 *
 * The followings are the available columns in table 'kom':
 * @property integer $id
 ...
 */
class Kom extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_material, tanggal, tempat, tgl_create, keterangan', 'required'),
			array('id_material', 'numerical', 'integerOnly'=>true),
			array('tempat', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_material, tanggal, tempat, tgl_create, keterangan', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Kom the static model class
	 */
