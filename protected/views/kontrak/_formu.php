...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
            <?php echo 'Dokumen Kontrak dengan '.$modal->usera->nama.' yang telah di upload : '.'<a href="/mts/dokumen/kontrak/'.$model->file_kontrak.'">'.$model->file_kontrak.'</a>' ?>
            <br>
			<?php echo '<b>Upload Dokumen Kontrak baru : </b><br>'.$form->fileField($model,'file_kontrak'); ?>
