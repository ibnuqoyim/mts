...
var id1=	$("#id").val();
    ...
    var url = script_url+"?callback=&progres="+progres+"&link="+link+"&name="+name+"&id="+id1+"&action=approve";
...
<div class="form">
  ...
  <?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
			...
			<?php echo $link = 'mashzone.iclov.com/attachment/'.$model->attachment ?>
	...
	<div class="row buttons" onclick="approve_value()">

		<?php echo CHtml::submitButton($model->isNewRecord ? 'Create' : 'Approve'); ?> <!--<input type="button" onclick="approve_value()" value="Update" />-->
	</div>
