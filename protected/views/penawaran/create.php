            ...
            <div class="info">
                <div class="container">
                    <div class="col-lg-4 left">
                        <a class="page"><span class="glyphicon glyphicon-user gold" aria-hidden="true"></span> Tender <?php echo $modal->nama?></a>
                    </div>
        ...
        <section class="container">
            <?php $this->renderPartial('_form', array('model'=>$model, 'list'=>$list,'modal'=>$modal, 'permintaan'=>$permintaan, 'dok_per'=> $dok_per)); ?>
        </section>