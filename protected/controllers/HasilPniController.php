...
class HasilPniController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('HasilPni');
	...
	{
		$model=new HasilPni('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['HasilPni']))
			$model->attributes=$_GET['HasilPni'];
	 ...
	 * @return HasilPni the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=HasilPni::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param HasilPni $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hasil-pni-form')
		{
