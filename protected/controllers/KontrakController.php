...
class KontrakController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Kontrak');
	...
	{
		$model=new Kontrak('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Kontrak']))
			$model->attributes=$_GET['Kontrak'];
	...
	{
		$model=Kontrak::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Kontrak $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='kontrak-form')
		{
